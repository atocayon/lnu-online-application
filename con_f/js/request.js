$(document).ready(function () {
  ...
  $(function () {
    $("#btn-submit").click(function () {
      if (
        ...
        $.ajax({
          url: "http://localhost/lnu-online-application/insert.php",
          type: "POST",
          dataType: "json",
          data: {
  ...
  $("#btn-admin-login").click(function () {
    if ($("#username").val() !== "" && $("#password").val() !== "") {
      $.ajax({
        url: "http://localhost/lnu-online-application/admin/login-action.php",
        type: "POST",
        dataType: "json",
        data: {
        ...
        success: function (data) {
          window.location.replace(
            "http://localhost/lnu-online-application/admin/"
          );
        },
        error: function (err) {
  ...
  $("#btn-set-schedule").click(function () {
    ...
    $.ajax({
      url:
        "http://localhost/lnu-online-application/admin/setApplicationPeriod-action.php",
      type: "POST",
      dataType: "json",
      data: {
        term: $("#term").val(),
  ...
  $(".btn-viewApplicant").click(function () {
    ...
    $.ajax({
      url: "http://localhost/lnu-online-application/admin/applicant.php",
      type: "POST",
      dataType: "json",
      data: {
        id: value,
      ...
      success: function (data) {
        ...
        $("#applicantLastSchoolAttendedType").text(
          data.typeOfSchoolLastAttended
        );
        $("#applicantLastSchoolAttendedCategory").text(
          data.categoryOfSchoolLastAttended
        );
        ...
        for (var i = 0; i < data.schoolAttended.length; i++) {
          ...
          for (var x = 0; x < data.schoolAttended[i]["school"].length; ++x) {
            ...
            tbl +=
              "<td><label>" +
              data.schoolAttended[i]["school"][x] +
              "</label></td>";
          }
          tbl += "</tr>";
        ...
        for (var z = 0; z < data.character_reference.length; z++) {
          ...
          for (
            var q = 0;
            q < data.character_reference[z]["reference"].length;
            ++q
          ) {
            //console.log(data.schoolAttended[i]['reference'][x]);
            tbl1 +=
              "<td><label>" +
              data.character_reference[z]["reference"][q] +
              "</label></td>";
          }
          tbl1 += "</tr>";
          //console.log(data.schoolAttended[i]['reference'][i]);
  ...
  $(".submitExamResult").click(function () {
    ...
    if (
      ...
      $.ajax({
        url:
          "http://localhost/lnu-online-application/admin/insertExamResult.php",
        type: "POST",
        dataType: "json",
        data: {
          id: value,
  ...
  $(".saveUser").click(function () {
    ...
    if (
      $("#" + value + "_inputUname").val() !== "" &&
      $("#" + value + "_inputPword").val() !== "" &&
      $("#" + value + "_inputRole").val() !== ""
    ) {
      $.ajax({
        url:
          "http://localhost/lnu-online-application/admin/updateAdminUserInfo.php",
        type: "POST",
        dataType: "json",
        data: {
          id: value,
  ...
  $(".deleteUser").click(function () {
    ...
    console.log(value);
    $.ajax({
      url: "http://localhost/lnu-online-application/admin/deleteAdminUser.php",
      type: "POST",
      dataType: "json",
      data: {
        id: value,
  ...
  $("#btn-addNewUser").click(function () {
    if (
      ...
      $.ajax({
        url: "http://localhost/lnu-online-application/admin/addAdminUser.php",
        type: "POST",
        dataType: "json",
        data: {
  ...
  $(".cancelApplicantInterviewee").click(function (event) {
    ...
    $("#" + value + "_development_deliveryOfInfo").css(
      "border",
      "1px solid #E0E0E0"
    );
  ...
  $(".saveApplicantInterviewee").click(function (event) {
    ...
    if (
      ...
      $.ajax({
        url:
          "http://localhost/lnu-online-application/admin/interviewResult.php",
        type: "POST",
        dataType: "json",
        data: {
          id: value,
          ...
          developmentDeliveryOfInfo: $(
            "#" + value + "_development_deliveryOfInfo"
          ).val(),
  ...
  $(".btn-getQualifiedDoneInterview").click(function () {
    ...
    $.ajax({
      url: "http://localhost/lnu-online-application/admin/getQualified.php",
      type: "POST",
      dataType: "json",
      data: {
        id: value,
  ...
  $(".btn-notQualifiedDoneInterview").click(function () {
    ...
    $.ajax({
      url: "http://localhost/lnu-online-application/admin/notQualified.php",
      type: "POST",
      dataType: "json",
      data: {
        id: value,
